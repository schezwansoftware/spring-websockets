...
describe('Component Tests', () => {
    describe('BankAccount Management Detail Component', () => {
        ...
        const route = ({ data: of({ bankAccount: new BankAccount('9fec3727-3421-4967-b213-ba36557ca194') }) } as any) as ActivatedRoute;
        ...
        describe('OnInit', () => {
            it('Should call load all on init', () => {
                ...
                // THEN
                expect(comp.bankAccount).toEqual(jasmine.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
            });
        });
    });
});
